...
<div class="al-page">
    <section class="al-hero">
        <div class="al-title">
            <h2>Danh sách ra/vào</h2>
            <p>Trang riêng để lễ tân tra cứu khách và xuất dữ liệu khi cần.</p>
        </div>
        <div class="al-actions">
            <a class="al-btn" href="{{ route('admin.access.index') }}"><i class="bi bi-arrow-left-right"></i> Làm thủ tục</a>
            <a class="al-btn primary" href="{{ route('admin.access.lists.export', request()->query()) }}"><i class="bi bi-file-earmark-spreadsheet"></i> Xuất Excel</a>
        </div>
    </section>
