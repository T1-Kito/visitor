...
.ks-mode-switch{display:flex;align-items:flex-start;gap:.75rem;padding:1rem;border:1px solid #fee2e2;border-radius:18px;background:linear-gradient(135deg,#fff7f7,#fff)}.ks-mode-switch input{width:44px;height:24px;flex:0 0 auto;margin-top:.1rem;accent-color:#d40511}.ks-mode-switch strong{display:block;color:#10233d;font-size:.92rem}.ks-mode-switch span{display:block;margin-top:.22rem;color:#64748b;font-size:.78rem;line-height:1.45}.ks-mode-badge{display:inline-flex;align-items:center;gap:.35rem;margin-top:.55rem;padding:.32rem .6rem;border-radius:999px;background:#fee2e2;color:#b91c1c;font-size:.72rem;font-weight:700}</style>
@endpush
...
@php
    ...
    $lobbyModeEnabled = old('lobby_mode_enabled', $settings['kiosk.lobby_mode_enabled'] ?? '0') === '1';
@endphp
    ...
    <div class="ks-settings-grid">
        <div class="ks-form-stack">
                ...
                <div class="ks-card-head">
                    <div>
                        <h2>Luồng vận hành kiosk</h2>
                        <p>Bật chế độ đặt kiosk tại sảnh để ẩn QR/email và cho lễ tân duyệt khách vào nhanh.</p>
                    </div>
                </div>
                <div class="ks-card-body">
                    <label class="ks-mode-switch">
                        <input type="checkbox" name="lobby_mode_enabled" value="1" @checked($lobbyModeEnabled)>
                        <span>
                            <strong>Bật chế độ kiosk tại sảnh</strong>
                            <span>Khi bật, hệ thống ẩn gửi Gmail/link đăng ký, ẩn QR chia sẻ/check-in trên giao diện chính và dùng nút “Duyệt & cho khách vào” tại chi tiết lịch hẹn.</span>
                            <em class="ks-mode-badge"><i class="bi bi-door-open"></i>Phù hợp kiosk đặt trước sảnh</em>
                        </span>
                    </label>
                </div>
            </section>
<section class="ks-card">
            ...
            <section class="ks-card">
                ...
                <div class="ks-card-body ks-grid-2">
                    <div class="ks-field">
                        <label>Số điện thoại hỗ trợ hiển thị trên kiosk <span class="required">*</span></label>
                        <input name="hotline" value="{{ $value('kiosk.hotline', '1900 0000') }}" placeholder="Ví dụ: 1900 0000 hoặc 0901 234 567" required>
                    </div>
                    <div class="ks-field">
