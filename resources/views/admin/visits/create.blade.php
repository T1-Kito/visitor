...
.vc-footer{justify-content:flex-end;gap:.6rem;margin-top:.75rem;padding:.75rem 0}
    ...
    <div class="vc-layout">
        <div class="vc-form-stack">
            ...
            <section class="vc-section">
                ...
                <div class="vc-section-body">
                    <div class="vc-grid">
                        ...
                        <input id="visitorNote" type="hidden" name="visitor_note" value="{{ old('visitor_note') }}">
                    </div>
                </div>
            </section>
            ...
            <div class="vc-footer">
                ...
                <button id="visitSubmitButton" class="vc-btn-main" type="submit" data-loading-text="Đang tạo...">
