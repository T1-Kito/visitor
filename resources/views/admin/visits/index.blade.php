        ...
        <div class="vs-table-scroll">
            <table class="vs-table">
                ...
                @forelse ($visits as $visit)
                    <tr class="vs-row" data-search="{{ strtolower($visit['code'].' '.$visit['visitor'].' '.$visit['host'].' '.$visit['creator'].' '.$visit['department'].' '.$visit['purpose']) }}" data-status="{{ $visit['status'] }}" data-department="{{ strtolower($visit['department']) }}">
