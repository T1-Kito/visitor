...
@push('styles')
<style>
.ap-stat-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem;margin-bottom:1rem}.ap-stat{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1rem;border:1px solid #e3edf8;border-radius:20px;background:#fff;box-shadow:0 12px 32px rgba(17,39,68,.05);min-width:0}.ap-stat span{display:block;color:#5f7895;font-size:.74rem;font-weight:900}.ap-stat strong{display:block;margin:.25rem 0;color:#0b1f3a;font-size:clamp(1.45rem,2vw,1.9rem);font-weight:900}.ap-stat small{color:#7c93ad;font-size:.72rem}.ap-stat-icon{width:54px;height:54px;display:grid;place-items:center;border-radius:20px;font-size:1.35rem;flex:0 0 auto}.ap-amber{background:#fff7ed;color:#d97706}.ap-green{background:#ecfdf5;color:#059669}.ap-red{background:#fff1f2;color:#e11d48}.ap-blue{background:#eff6ff;color:#146bd7}.ap-main{background:#fff;border:1px solid #e3edf8;border-radius:22px;box-shadow:0 14px 36px rgba(17,39,68,.05);overflow:hidden;max-width:100%}.ap-filter{display:grid;grid-template-columns:minmax(220px,1fr) minmax(135px,.35fr) minmax(170px,.45fr) minmax(170px,.45fr) auto;gap:.75rem;padding:1rem;border-bottom:1px solid #edf3fb}.ap-filter .form-control,.ap-filter .form-select{min-height:42px;border-color:#dce8f6;border-radius:12px;font-size:.82rem}.ap-filter .btn{min-height:42px;border-radius:12px;font-weight:900;white-space:nowrap}.ap-tabs{display:flex;gap:1.15rem;padding:1rem 1rem 0;border-bottom:1px solid #edf3fb;overflow-x:auto;scrollbar-width:thin}.ap-tab{position:relative;padding:0 0 .85rem;border:0;background:transparent;color:#526b87;font-size:.8rem;font-weight:900;white-space:nowrap}.ap-tab.active,.ap-tab:hover{color:#146bd7}.ap-tab.active:after{content:"";position:absolute;left:0;right:0;bottom:-1px;height:3px;border-radius:999px;background:#146bd7}.ap-tab em{font-style:normal;margin-left:.35rem;padding:.12rem .45rem;border-radius:999px;background:#edf5ff;color:#146bd7;font-size:.68rem}.ap-list{display:grid;gap:.75rem;padding:1rem;background:#f8fbff;max-width:100%;overflow:hidden}.ap-row{position:relative;display:grid;grid-template-columns:44px minmax(105px,.75fr) minmax(130px,1fr) minmax(130px,1fr) minmax(95px,.65fr) minmax(92px,.62fr) minmax(115px,.8fr) minmax(95px,.58fr) minmax(130px,.7fr);gap:.65rem;align-items:center;width:100%;min-width:0;padding:.9rem;border:1px solid #e5eef9;border-radius:18px;background:#fff;box-shadow:0 10px 26px rgba(17,39,68,.035);transition:.16s}.ap-row:hover{transform:translateY(-1px);border-color:#bfd7f3;box-shadow:0 16px 34px rgba(17,39,68,.07)}.ap-row[data-status="approved"]{background:linear-gradient(90deg,#fff,#f4fdf8)}.ap-row[data-status="rejected"]{background:linear-gradient(90deg,#fff,#fff7f7)}.ap-row-link{position:absolute;inset:0;z-index:1;border-radius:18px}.ap-row>div{position:relative;z-index:2;pointer-events:none}.ap-actions,.ap-actions *{pointer-events:auto}.ap-avatar{width:42px;height:42px;display:grid;place-items:center;border-radius:14px;background:#eaf3ff;color:#146bd7;font-weight:900}.ap-cell-label{display:block;margin-bottom:.2rem;color:#7a93b0;font-size:.64rem;font-weight:900}.ap-code{display:block;color:#0b1f3a;font-size:.78rem;font-weight:900}.ap-created{display:block;margin-top:.2rem;color:#7a93b0;font-size:.64rem}.ap-primary{display:block;color:#0b1f3a;font-size:.82rem;font-weight:900;line-height:1.25}.ap-secondary{display:block;margin-top:.18rem;color:#526b87;font-size:.7rem;line-height:1.25}.ap-purpose{display:block;color:#0b1f3a;font-size:.78rem;font-weight:800;line-height:1.25}.ap-actions{display:flex;justify-content:flex-end;gap:.45rem;align-items:center;flex-wrap:wrap;min-width:0}.ap-actions form{display:inline-flex}.ap-btn{min-height:34px;display:inline-flex;align-items:center;justify-content:center;gap:.35rem;border-radius:11px;padding:.42rem .72rem;font-size:.72rem;font-weight:900;text-decoration:none;white-space:nowrap}.ap-btn-approve{border:1px solid #bbf7d0;background:#ecfdf5;color:#059669}.ap-btn-reject{border:1px solid #fecaca;background:#fff7f7;color:#dc2626}.ap-done{border:1px solid #d8e5f2;background:#f8fbff;color:#526b87}.ap-wait{display:inline-flex;align-items:center;gap:.25rem;width:max-content;margin-top:.35rem;padding:.18rem .5rem;border-radius:999px;background:#fff7ed;color:#d97706;font-size:.66rem;font-weight:900}.ap-empty{padding:3rem;text-align:center;color:#7a93b0}.ap-empty i{display:block;margin-bottom:.5rem;color:#bfd3eb;font-size:2.4rem}.ap-footer{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1rem;color:#526b87;font-size:.8rem;background:#fff}.ap-pages{display:flex;gap:.4rem}.ap-pages span{width:34px;height:34px;display:grid;place-items:center;border:1px solid #d8e5f2;border-radius:10px;color:#29435f;font-weight:900}.ap-pages .active{background:#146bd7;border-color:#146bd7;color:#fff}@media(max-width:1600px){.ap-stat-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.ap-filter{grid-template-columns:minmax(220px,1fr) 150px 180px 180px auto}.ap-row{grid-template-columns:40px minmax(100px,.7fr) minmax(120px,1fr) minmax(120px,1fr) minmax(88px,.6fr) minmax(88px,.6fr) minmax(105px,.72fr) minmax(90px,.55fr) minmax(122px,.66fr);gap:.5rem;padding:.8rem}.ap-btn{padding:.38rem .58rem;font-size:.7rem}}@media(max-width:1350px){.ap-stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.ap-filter{grid-template-columns:1fr 1fr}.ap-row{grid-template-columns:42px repeat(3,minmax(0,1fr));align-items:start}.ap-row>div:nth-child(n+6){grid-column:auto}.ap-actions{grid-column:2/-1;justify-content:flex-start}.ap-status-cell{grid-column:auto}}@media(max-width:900px){.ap-stat-grid,.ap-filter{grid-template-columns:1fr}.ap-list{padding:.75rem}.ap-row{grid-template-columns:1fr;gap:.75rem}.ap-avatar{display:none}.ap-actions{grid-column:auto;justify-content:flex-start}.ap-footer{flex-direction:column;align-items:flex-start}}
</style>
@endpush
