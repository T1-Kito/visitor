...
.mr-export a{color:var(--m-primary)}
.mr-filter button{background:var(--m-secondary);color:#111827}
.mr-filter button i{color:var(--m-primary)}
.mr-stat:not(.green):not(.orange):not(.purple) i{background:#fff8d6;color:var(--m-primary)}
.mr-progress span{background:var(--m-primary)}
.mr-avatar{background:#fff8d6;color:var(--m-primary)}
</style>
@endpush
