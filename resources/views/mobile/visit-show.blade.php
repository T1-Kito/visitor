...
.mv-qr{background:linear-gradient(145deg,#fff,#fff9df)}
.mv-token,.mv-qr-note i,.mv-panel-title i{color:var(--m-primary)}
.mv-step.current i{box-shadow:0 0 0 4px rgba(212,5,17,.12);background:#fff8d6;color:var(--m-primary)}
.mv-history-item i{background:#fff8d6;color:var(--m-primary)}
</style>
@endpush
